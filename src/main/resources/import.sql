...
INSERT INTO Producto VALUES (1, 'Zapatillas', 'Nuevas zapatillas colaboracion entre Kanye West y Adidas. Presentan un upper con diferentes materiales como primeknit azul, mesh gris y neopreno negro unidas por una estructura de plastico translucida que brilla en la oscuridad.', 'Adidas Yeezy 700', '42.5');
INSERT INTO Producto VALUES (2, 'Zapatillas', 'Nuevas zapatillas creadas por el rapero Kanye West en colaboracion con la marca alemana. Presenta una mediasuela de BOOST, una tecnologia de adidas para mejorar la comodidad y un upper primeknit que llena zapatilla de diferentes texturas.', 'Adidas Yeezy Boost 350', '45');
