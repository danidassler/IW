...
INSERT INTO Usuario VALUES (6, 'ZHOZO' , 1, 'Daniel2', '{bcrypt}$2a$10$xLFtBIXGtYvAbRqM95JhcOaG23fHRpDoZIJrsF2cCff9xEHTTdK1u', 'USER',1000, 'daniel2');
INSERT INTO Usuario VALUES (200, 'Zapas' , 1, 'Zapas', '{bcrypt}$2a$10$xLFtBIXGtYvAbRqM95JhcOaG23fHRpDoZIJrsF2cCff9xEHTTdK1u', 'USER',1000, 'zapas');

INSERT INTO Producto VALUES (1, 'Zapatillas,Yeezy', 'Nuevas zapatillas colaboracion entre Kanye West y Adidas. Presentan un upper con diferentes materiales como primeknit azul, mesh gris y neopreno negro unidas por una estructura de plastico translucida que brilla en la oscuridad.', 1,'Adidas Yeezy 700 v3', '42.5');
INSERT INTO Producto VALUES (2, 'Zapatillas', 'Nuevas zapatillas creadas por el rapero Kanye West en colaboracion con la marca alemana. Presenta una mediasuela de BOOST, una tecnologia de adidas para mejorar la comodidad y un upper primeknit que llena zapatilla de diferentes texturas.', 1,'Adidas Yeezy Boost 350 v2', '45');
INSERT INTO Producto VALUES (3, 'Zapatillas', 'Colaboracion entre Nike y Jordan plasmada en la silueta de la Jordan 1 High OG. Esta zapatilla lanzada en 2019 presenta un upper de cuero con unos detalles en ante desgastado de color azul-verdoso. Ademas contienen un segundo par de cordones.', 1,'Air Jordan 1 "Turbo Green"', '39');
INSERT INTO Producto VALUES (4, 'Streetwear', 'Sudadera de la conocida marca de Streetwear perneteciente a la temporada FW16. En esta temporada Supreme lanzo al mercado esta sudadera en este color verde oliva, junto con 5 colores mas. Este es uno de los colores mas deseados de la temporada.', 1,'Supreme Box Logo Hoodie "Olive"', 'L');
INSERT INTO Producto VALUES (5, 'Accesorios', 'Zeppelin inflable de Supreme. Presenta una cuerda larga para poder colgarlo y utilizarlo como decoracion. Perteneciente a la temporada Fall-Winter 17, donde supreme saco un gran numero de accesorios nunca vistos. Hazte con el tuyo ya!', 1,'Supreme Inflatable Blimp', 'Unica');
INSERT INTO Producto VALUES (6, 'Relojes', 'Reloj de la lujosa marca ROLEX. Solo existen 500 unidades de este lujoso reloj en todo el mundo. En nuestra tienda, puedes obtener este Rolex GTM nuevo y original. Presenta una construcion de acero inoxidable y una esfera negra elegante.', 1,'Rolex GTM-Master II "Batman"', 'Unica');
INSERT INTO Producto VALUES (7, 'Electronica', 'Consola de ultima generacion de Sony que esta arrasando en el mercado. La consola tiene un color blanco e inluye un mando de color blanco a juego. Con una capacidad de 1TB tienes capacidad para almacenar todos los juegos que necesites!', 1,'Sony Play Station 5', '1 TB');
...
INSERT INTO Color VALUES (5, 'Verde');
INSERT INTO Color VALUES (6, 'Oliva');
INSERT INTO Color VALUES (7, 'Amarillo');
INSERT INTO Color VALUES (8, 'Morado');
INSERT INTO Color VALUES (9, 'Naranja');
INSERT INTO Color VALUES (10, 'Gris');
INSERT INTO Color VALUES (11, 'Marron');

INSERT INTO Producto_Colores VALUES (1, 2);
INSERT INTO Producto_Colores VALUES (1, 3);
INSERT INTO Producto_Colores VALUES (1, 4);
INSERT INTO Producto_Colores VALUES (2, 1);
INSERT INTO Producto_Colores VALUES (2, 2);
INSERT INTO Producto_Colores VALUES (3, 4);
INSERT INTO Producto_Colores VALUES (3, 3);
INSERT INTO Producto_Colores VALUES (4, 6);
INSERT INTO Producto_Colores VALUES (5, 4);
INSERT INTO Producto_Colores VALUES (6, 10);
INSERT INTO Producto_Colores VALUES (7, 4);
